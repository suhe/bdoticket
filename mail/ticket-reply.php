										...
										<tbody>
											...
											<tr style="padding: 5px">
												...
												<td valign="top" bgcolor="#FFFFFF"
													...
													<div style="margin: 0 0 0 10px; padding: 0">
														<small style="margin: 0; padding: 0"><b
															style="margin: 0; padding: 0"> <a target="_blank"
																style="margin: 0; padding: 0; color: #0f990f; text-decoration: none"
																href="#"><?=$data->employee_from_name?></a></b> </small><br
															style="margin: 0; padding: 0">
														<small style="margin: 0; padding: 0; color: #999"><?=$data->log_date?></small>
													</div>

													<div style="padding-top: 5px; margin: 0 0 0 10px">
														<p
															style="margin: 0; padding: 0; margin-bottom: 20px; font-weight: normal; font-size: 14px; line-height: 1.6"><?=$data->log_desc?></p>
													</div>
											...
											<tr>
												...
												<td width="100" valign="top" bgcolor="#FFFFFF"
													style="background: #ffffff; border-collapse: collapse; padding: 5px; text-align: center"
													colspan="8">
													<div style="margin: 0; padding: 0">
														<a target="_blank"
															...
															href="<?=Yii::$app->params["mail_site"] ?>"><?=Yii::t('app','reply')?></a>
													</div>
												</td>
											</tr>
										</tbody>
