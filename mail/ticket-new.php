							...
							<tr>
								<td valign="top" style="border-collapse: collapse">
									<div align="center" style="color: #808080; font-family: Arial; font-size: 11px; line-height: 150%; text-align: center">
										<?=Yii::t('app/message','new ticket')?>
									</div>

									<div align="center" style="color: #808080; font-family: Arial; font-size: 11px; line-height: 150%; text-align: center">
										<?=Yii::t('app/message','msg this email see at not normal')?>
										<a target="_blank" style="color: #a30046; font-weight: normal; text-decoration: underline" href="<?=Yii::$app->params['mail_site']?>"><?=Yii::t('app/message','msg see at your browser')?></a>
									</div>
								</td>
							</tr>
						</tbody>
										...
										<tbody>
											<tr>
												<td valign="top" align="left"
													...
													<a target="_blank" style="color: #a30046; font-weight: normal; text-decoration: none"
													href="<?=Yii::$app->params["mail_site"]?>">
														<img
														...
														alt="<?=Yii::$app->params["mail_site"]?> - ticket online"
														class="CToWUd">
												</a>
												...
												<td valign="top" bgcolor="#FFFFFF"
													...
													<div align="right" style="text-align: right">
														<a target="_blank" href="http://www.bdo.co.id"><img
															...
															alt="Bdo indonesia" class="CToWUd"></a>
													</div>
